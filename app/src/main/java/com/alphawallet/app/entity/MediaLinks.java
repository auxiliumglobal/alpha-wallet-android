...
{
    public static final String AWALLET_TELEGRAM_URL = null;
    ...
    public static final String AWALLET_FORUM_URL = "https://forum.auxilium.global/c/support/10";

    public static final String AWALLET_EMAIL1 = "feedback+android";
    public static final String AWALLET_EMAIL2 = "alphawallet.com";
    public static final String AWALLET_SUBJECT = "Hi guys. I've been using Auxilium Wallet";
}
